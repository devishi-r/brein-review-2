...
def letter(handpoints, image):
    ...
    if(handpoints[5].x<handpoints[6].x and 
       ...
       handpoints[0].y<handpoints[17].y and
       
       handpoints[0].x<handpoints[17].x):
        return "H"
    ...
    if(handpoints[0].x<handpoints[1].x and
        ...
        handpoints[4].y<handpoints[3].y and

        handpoints[19].x>handpoints[14].x and
        handpoints[20].x>handpoints[18].x):
        return "J"
